...
declare global {
	namespace JSX {
		...
		type IntrinsicElements = {
			[K in keyof Instances as Lowercase<K> extends keyof SupportedInstances ? Lowercase<K> : K]: Instances[K] extends Instance ? Vide.InstanceAttributes<Instances[K]> : never
		}
	}
}
